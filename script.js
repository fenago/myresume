...
// --- DATA ---
const IMPACT_STATS = [
    { label: "Threat Detection", value: "40%", desc: "Accuracy improvement using NLP.", icon: "shield-alert" },
    { label: "Processing Speed", value: "60%", desc: "Reduction in processing time.", icon: "zap" },
    { label: "Customer Support", value: "35%", desc: "Improvement via LLM deployment.", icon: "message-square" },
    { label: "Scale", value: "100K+", desc: "Students reached via Blockchain.", icon: "users" }
];
...
function renderPublications(filter = '') {
    ...
    if (filtered.length === 0) {
        list.innerHTML = `<div class="text-center py-20 text-gray-500">No matching publications.</div>`;
    }
